...
public abstract class CustomSwipe extends ItemTouchHelper.SimpleCallback {
    ...
    public CustomSwipe(Context context, RecyclerView recyclerView, int buttonWidth) {
    ...
    public class MyButton {
        ...
        private AttributeContext.Resource resource;

        public MyButton(Context context, String text, int imageResId, int textSize, int color, MyButtonOnClickListener listener) {
            this.text = text;
